...
const WarningModal = ({ open, onOpenChange }: ModalProps) => {
    ...
    function onSubmit(data: FormValues) {
        const payload = {
            modalId: warningData.id,
            action: warningData.cta.action,
            checkedItems: data,
        };
            ...
            >
                ...
                <DialogHeader>
                    <DialogTitle className="text-center text-lg font-semibold flex flex-col items-center gap-3.5">
                        ...
                        <p className="font-semibold text-lg leading-[110%]">Standard Warning</p>
                    </DialogTitle>
                </DialogHeader>
                ...
                <div className="flex flex-col items-center gap-3">
                    <p className="text-sm leading-[160%] text-[#D2D2D5] text-center">
                        ...
                        Submitting false, misleading, or malicious reports may lead to disciplinary
                        action according to organizational policy.
                    </p>
                ...
                {/* Warning List */}
                <div className="mt-4">
                    <h1 className="font-medium text-lg leading-[160%]">{warningData.title}</h1>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex items-start gap-3">
                                            ...
                                            <Label className="text-sm text-[#D2D2D5] leading-[160%]">
                                                {item.text}
